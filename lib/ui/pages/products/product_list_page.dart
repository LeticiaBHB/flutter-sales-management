...
import '../../widgets/image_display_widget.dart'; // Import do widget novo
          ...
          : asyncState.error != null
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                    ...
                    return ListTile(
                      // CORREÇÃO: Usar prod.imagens.first em vez de 'placeholder'
                      leading: prod.imagens.isNotEmpty
                          ? ImageDisplayWidget(imagePath: prod.imagens.first)
                          : const Icon(Icons.image_not_supported),
                      title: Text(prod.descricao),
                      subtitle: Text('R\$ ${prod.valorVenda.toStringAsFixed(2)} | Estoque: ${prod.estoque}'),
                      trailing: Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () => Navigator.push(
                              context,
                              MaterialPageRoute(builder: (_) => ProductFormPage(product: prod)),
                            ),
                          ),
                          IconButton(
